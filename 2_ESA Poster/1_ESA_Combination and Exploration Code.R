#JJC to do: 
#1-update nestling ages and nestling numbers for whole dataset
#2-import pasture-scale vegetation for 2021
...
#Jaime comp wd
setwd("~/Dropbox/_Manuscripts/Dipping/NestCameraAnalysis/")
...
veg<-read_csv("Data_May 2022/NestVeg_2.Mar.2022.csv")%>%  #Check about NAs in dataset
...
save(veg,file="Data_July 2022/Veg.RData")

#Nestling numbers for updated nests as of 1.2.22 #These need to be updated
NestlingNums <- read_excel("Data_July 2022/NestlingNums21_1.2.22.xlsx")%>%
